...
fun SurfaceSample() {
    ...
    Column(
        ...
        Surface(
            modifier = Modifier
                .fillMaxWidth()
                .defaultMinSize(minHeight = 80.dp), color = AppTheme.colors.primary
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "It can be of any shape.", textAlign = TextAlign.Center, style = AppTheme.typography.label1
                )
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "With elevation.", textAlign = TextAlign.Center, style = AppTheme.typography.label1
                )
