package com.nomanr.lumo.multiplatform.sample.home.components
...
import com.nomanr.lumo.multiplatform.ui.LocalTypography
import com.nomanr.lumo.multiplatform.ui.components.ModalBottomSheet
    ...
    Column {
        ...
        Row(
            ...
            Box(modifier = Modifier.weight(0.2f), contentAlignment = Alignment.Center) {
                Text("${round(appConfigState.fontScale * 100.0) / 100.0}", style = AppTheme.typography.label2)
            }
        }
    }
}
